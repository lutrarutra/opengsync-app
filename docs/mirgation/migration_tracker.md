...
| 12 | **Share Project Data** | `workflows/share/` | `actions/ShareProjectDataAction.py` | Single-step `ShareProjectDataAction` (not a workflow). Project page Share Data starts `ShareProjectDataAction.Begin`. File-browser Assign is `AssociatePathAction` (not a workflow step). |
