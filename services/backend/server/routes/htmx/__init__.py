...
router.include_router(share_tokens.router, dependencies=[Depends(auth.dependencies.require_user)])
router.include_router(users.router, dependencies=[Depends(auth.dependencies.require_user)])
router.include_router(affiliations.router, dependencies=[Depends(auth.dependencies.require_user)])
...
router.include_router(features.router, dependencies=[Depends(auth.dependencies.require_user)])
router.include_router(plots.router, dependencies=[Depends(auth.dependencies.require_insider)])
router.include_router(api_tokens.router, dependencies=[Depends(auth.dependencies.require_user)])