...
router.include_router(wf.check_barcode_clashes.CheckBarcodeClashesWorkflow.Router())
...
router.include_router(wf.library_prep.LibraryPrepWorkflow.Router())
...
router.include_router(wf.reseq.ReseqWorkflow.Router())
router.include_router(wf.merge_pools.MergePoolsWorkflow.Router())
router.include_router(wf.select_pool_libraries.SelectPoolLibrariesWorkflow.Router())
...
router.include_router(wf.billing.BillingWorkflow.Router())
