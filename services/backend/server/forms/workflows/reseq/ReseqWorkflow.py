...
class ReseqWorkflow(HTMXWorkflow):
    ...
    def Previous(cls, step: str) -> WorkflowFunc:
        def dependency(
            workflow: "ReseqWorkflow" = Depends(ReseqWorkflow.Init(step)),
        ) -> "ReseqWorkflow":
    ...
    def Router(cls) -> APIRouter:
        ...
        router.add_api_route("/begin", ReseqWorkflow.Begin(), methods=["GET"], name="ReseqWorkflow.begin")
        return router
