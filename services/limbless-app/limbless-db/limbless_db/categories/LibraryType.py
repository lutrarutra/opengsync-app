...
class LibraryType(ExtendedEnum[LibraryTypeEnum], enum_type=LibraryTypeEnum):
    ...
    CRISPR_SCREENING = LibraryTypeEnum(11, "CRISPR Screening", "CRISPR Screening", "CRISPR", "CRISPR Screening")
    TENX_FLEX = LibraryTypeEnum(12, "10x Fixed RNA Profiling (Flex)", "10X Flex", "GEX", "Gene Expression")
    ...
    EM_SEQ = LibraryTypeEnum(107, "Enzymatic Methyl-seq", "EM", "EM", "Methylation Profiling")
