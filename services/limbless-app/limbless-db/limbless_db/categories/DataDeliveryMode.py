...
class DataDeliveryMode(ExtendedEnum[DataDeliveryModeEnum], enum_type=DataDeliveryModeEnum):
    ...
    DOWNSTREAM = DataDeliveryModeEnum(4, "Downstream analysis", "We will provide you with the results of the downstream analysis. Pick this option only if you have discused the goal of the analysis with us.")
