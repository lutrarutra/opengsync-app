...
class AssayType(ExtendedEnum[AssayTypeEnum], enum_type=AssayTypeEnum):
    ...
    # 10x Genomics, Flex single-cell RNA-seq with cell fixation
    TENX_SC_GEX_FLEX = AssayTypeEnum(10, "10X Single Cell Gene Expression Flex", "10X Flex", "10X Chromium", False, library_types=[LibraryType.TENX_SC_GEX_FLEX], optional_library_types=[LibraryType.TENX_ANTIBODY_CAPTURE])
    ...
    TENX_SC_GEX_3PRIME = AssayTypeEnum(12, "10X Single Cell Gene Expression 3'", "10X 3'", "10X Chromium", True, library_types=[LibraryType.TENX_SC_GEX_3PRIME], optional_library_types=[LibraryType.TENX_ANTIBODY_CAPTURE])
    # 10x Genomics 5' single-cell RNA-seq
    TENX_SC_GEX_5PRIME = AssayTypeEnum(13, "10X Single Cell Immune Profiling 5'", "10X 5'", "10X Chromium", True, library_types=[LibraryType.TENX_SC_GEX_5PRIME], optional_library_types=[LibraryType.TENX_ANTIBODY_CAPTURE, LibraryType.TENX_CRISPR_SCREENING, LibraryType.TENX_VDJ_B, LibraryType.TENX_VDJ_T, LibraryType.TENX_VDJ_T_GD])
    # 10x Genomics, single-cell multiome ATAC-seq and RNA-seq
